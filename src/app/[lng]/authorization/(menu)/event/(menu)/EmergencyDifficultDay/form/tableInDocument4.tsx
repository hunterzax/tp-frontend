...
const TableDocument4: React.FC<TableProps> = ({ tableData, isLoading, columnVisibility, dataOpenDocument }) => {
                    ...
                    {sortedData && sortedData?.map((row: any, index: any) => {
                        return (
                            ...
                            >
                                ...
                                <td className="px-4 py-1 text-center">
                                    <div className="mx-auto flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]">
                                        <button type="button" className={class_btn_} disabled={false}
                                            onClick={() => handleDownloadPDFTsoViewEmer('doc4', row?.id, row?.update_by, row?.group_id)}
                                        >
                                ...
                                <td className="px-4 py-1 text-[#464255] ">{row?.doc_4_input_shipper_operation}</td>
                                <td className="px-4 py-1 text-[#464255] ">{row?.doc_4_input_shipper_note}</td>
