...
const TableDocument3: React.FC<TableProps> = ({ tableData, isLoading, columnVisibility, dataOpenDocument }) => {
                                ...
                                <td className="px-4 py-1 text-center">
                                    <div className="mx-auto flex w-[120px] justify-center rounded-full px-1 py-2 text-[#464255]">
                                        <button type="button" className={class_btn_} disabled={false}
                                            ...
                                            onClick={() => handleDownloadPDFTsoView('doc3', row?.id, row?.update_by, row?.group_id)}
                                        >
