...
export const ContractRowWhite = ({
  ...
  // Helper function to sum all detail_entry_east_ tags except excluded ones
  ...
  const getFormattedValueByTag = (tag: string) => {
    const item = contract?.values?.find((item: any) => item?.tag === tag);
  ...
  return (
    <tr
      key={`contract-${row?.request_number ?? 'unknown'}-${cIdx ?? 0}-${index ?? 0}`}
    ...
    >
      ...
      {columnVisibility.gas_day && (
        <td className="px-2 py-1 text-[#5A4600] bg-[#ffffff] text-center sticky left-0 z-[2]" colSpan={1}>
      ...
      {columnVisibility.summary_pane && (<>
        ...
        {columnVisibility.shipper_name && (
          <td className={`px-2 py-1 text-[#5A4600] bg-[#ffffff] text-center sticky left-[120px] z-[2]  ${!columnVisibility.gas_day && '!left-[0px]'}`} colSpan={1}>
            {/* {shipperItem?.shipper || ""} */}
            <div className="w-[200px]">{find_shipper_name ? find_shipper_name?.name : shipperItem?.shipper}</div>
          </td>
        )}

        {columnVisibility.contract_code && (
          <td
            className={`px-2 py-1 text-[#5A4600] bg-[#ffffff] text-center sticky z-[2]
            ...
            colSpan={1}
          >
            <div className="w-[150px]">{contract?.contract || ""}</div>
          </td>
        )}
        ...
        {columnVisibility.east_total_entry_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[0]?.value) : ''} */}
        ...
        {columnVisibility.west_total_entry_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[1]?.value) : ''} */}
        ...
        {columnVisibility.east_west_total_entry_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[2]?.value) : ''} */}
        ...
        {columnVisibility.east_total_exit_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[3]?.value) : ''} */}
        ...
        {columnVisibility.west_total_exit_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[4]?.value) : ''} */}
        ...
        {columnVisibility.east_west_total_exit_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[5]?.value) : ''} */}
        ...
        {columnVisibility.east_imbalance_zone_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[63]?.value) : ''} */}
        ...
        {columnVisibility.west_imbalance_zone_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[64]?.value) : ''} */}
        ...
        {columnVisibility.total_imbalance_zone_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[65]?.value) : ''} */}
        ...
        {columnVisibility.east_instructed_flow_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[32]?.value) : ''} */}
        ...
        {columnVisibility.west_instructed_flow_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[33]?.value) : ''} */}
        ...
        {columnVisibility.east_shrinkage_volume_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[6]?.value) : ''} */}
        ...
        {columnVisibility.west_shrinkage_volume_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[7]?.value) : ''} */}
        ...
        {columnVisibility.east_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[12]?.value) : ''} */}
        ...
        {columnVisibility.west_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[13]?.value) : ''} */}
        ...
        {columnVisibility.east_unpark_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[15]?.value) : ''} */}
        ...
        {columnVisibility.west_unpark_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[16]?.value) : ''} */}
        ...
        {columnVisibility.east_sod_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[20]?.value) : ''} */}
        ...
        {columnVisibility.west_sod_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[21]?.value) : ''} */}
        ...
        {columnVisibility.east_eod_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[23]?.value) : ''} */}
        ...
        {columnVisibility.west_eod_park_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[24]?.value) : ''} */}
        ...
        {columnVisibility.east_min_inventory_change_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[9]?.value) : ''} */}
        ...
        {columnVisibility.west_min_inventory_change_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[10]?.value) : ''} */}
        ...
        {columnVisibility.east_reserve_bal_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[18]?.value) : ''} */}
        ...
        {columnVisibility.west_reserve_bal_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[19]?.value) : ''} */}
        ...
        {columnVisibility.east_adjust_imbalance_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[66]?.value) : ''} */}
        ...
        {columnVisibility.west_adjust_imbalance_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[67]?.value) : ''} */}
        ...
        {columnVisibility.east_vent_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[26]?.value) : ''} */}
        ...
        {columnVisibility.west_vent_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[27]?.value) : ''} */}
        ...
        {columnVisibility.east_commissioning_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[28]?.value) : ''} */}
        ...
        {columnVisibility.west_commissioning_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[29]?.value) : ''} */}
        ...
        {columnVisibility.east_other_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[30]?.value) : ''} */}
        ...
        {columnVisibility.west_other_gas && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[31]?.value) : ''} */}
        ...
        {columnVisibility.east_daily_imb_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[68]?.value) : ''} */}
        ...
        {columnVisibility.west_daily_imb_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[69]?.value) : ''} */}
        ...
        {columnVisibility.total_aip_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[72]?.value) : ''} */}
        ...
        {columnVisibility.total_percentage_abslmb && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[73]?.value) : ''} */}
        ...
        {columnVisibility.east_acc_imb_month_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[77]?.value) : ''} */}
        ...
        {columnVisibility.west_acc_imb_month_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[78]?.value) : ''} */}
        ...
        {columnVisibility.east_acc_imb_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[81]?.value) : ''} */}
        ...
        {columnVisibility.west_acc_imb_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[82]?.value) : ''} */}
        ...
        {columnVisibility.east_min_inventory_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[74]?.value) : ''} */}
        ...
        {columnVisibility.west_min_inventory_mmbtud && (
          <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
            {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[75]?.value) : ''} */}
      ...
      {columnVisibility.detail_pane && (
        <>
          ...
          {columnVisibility.gsp && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[34]?.value) : ''} */}
          ...
          {columnVisibility.bypass_gas && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[35]?.value) : ''} */}
          ...
          {columnVisibility.lng && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[36]?.value) : ''} */}
          ...
          {/* Sum of all detail_entry_east_ tags except excluded ones */}
          {columnVisibility.others_east && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {/* {contract?.values.find((item: any) => item?.tag === 'detail_entry_east_others') ? formatNumberFourDecimal(contract?.values.find((item: any) => item?.tag === 'detail_entry_east_others')?.value) : ''} */}
              {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_entry_east_', ['gsp', 'bypassGas', 'lng']))}
            </td>
          )}
          ...
          {columnVisibility.ydn && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[37]?.value) : ''} */}
          ...
          {columnVisibility.ytg && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[38]?.value) : ''} */}
          ...
          {columnVisibility.ztk && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[39]?.value) : ''} */}
          ...
          {columnVisibility.others_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_entry_west_', ['yadana', 'yetagun', 'zawtika']))}
            </td>
          )}
          ...
          {columnVisibility.ra6_east && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[40]?.value) : ''} */}
          ...
          {columnVisibility.ra6_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[41]?.value) : ''} */}
          ...
          {columnVisibility.bvw10_east && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[42]?.value) : ''} */}
          ...
          {columnVisibility.bvw10_West && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[43]?.value) : ''} */}
          ...
          {columnVisibility.egat && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[44]?.value) : ''} */}
          ...
          {columnVisibility.ipp && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[45]?.value) : ''} */}
          ...
          {columnVisibility.others_east_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_exit_east_', ['egat', 'ipp']))}
            </td>
          )}
          ...
          {columnVisibility.egat_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[49]?.value) : ''} */}
          ...
          {columnVisibility.ipp_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[50]?.value) : ''} */}
          ...
          {columnVisibility.others_west_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_exit_west_', ['egat', 'ipp']))}
            </td>
          )}
          ...
          {columnVisibility.egat_east_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[54]?.value) : ''} */}
          ...
          {columnVisibility.ipp_east_west && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[55]?.value) : ''} */}
          ...
          {columnVisibility.others_east_west_exit && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {`no_data`} */}
              {formatNumberFourDecimal(sumDetail(contract?.values, 'detail_exit_east-west_', ['egat', 'ipp']))}
            </td>
          )}
          ...
          {columnVisibility.east_f2andg && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[59]?.value) : ''} */}
          ...
          {columnVisibility.west_f2andg && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[60]?.value) : ''} */}
          ...
          {columnVisibility.east_e && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[61]?.value) : ''} */}
          ...
          {columnVisibility.west_e && (
            <td className={`px-2 py-1 text-[#5A4600] text-right`} scope="col">
              {/* {contract?.values ? formatNumberFourDecimal(contract?.values?.[62]?.value) : ''} */}
