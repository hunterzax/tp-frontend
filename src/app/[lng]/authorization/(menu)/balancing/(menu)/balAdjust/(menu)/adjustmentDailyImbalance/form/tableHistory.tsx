...
const TableBalAdjustmentDailyImbalanceHistory: React.FC<TableProps> = ({ tableData, isLoading, columnVisibility, initialColumns }) => {
    ...
    // History : ชื่อคอลัมน์ ตัดคำว่า Acc. ออก https://app.clickup.com/t/86euuf518 
...
export default TableBalAdjustmentDailyImbalanceHistory;