                    ...
                    >
                        <div className="flex inset-0 items-center justify-center ">
                            <div className="flex flex-col items-center justify-center gap-2 rounded-md w-[700px]">
                                ...
                                >
                                    <h2 className="text-xl font-bold text-[#00ADEF] mb-4 pb-5">{mode === 'create' ? 'Add' : mode === 'edit' ? 'Edit' : mode === 'view' ? 'View' : 'Duplicate'}{` Other Group`}</h2>

                                    <div className="grid grid-cols-2 gap-x-[20px] gap-y-2">
                                        <div className="pb-2">
                                            <label className={labelClass}><span className="text-red-500">*</span>{`Other ID`}</label>
                                            <input
                                                type="text"
                                                {...register('id_name', { required: "Enter Other ID" })}
                                        ...
                                        <div className="pb-2">
                                            <label className={labelClass}><span className="text-red-500">*</span>{`Other name`}</label>
                                            <input
                                                type="text"
                                                {...register('name', { required: "Enter Other name" })}
                                        ...
                                        <div className="pb-2">
                                            ...
                                            <Select
                                                id='select_other_group_division'
                                                {...register('division')}
                                                ...
                                                multiple
                                                className={`${selectboxClass} ${isReadOnly && '!bg-[#EFECEC]'} ${errors.division && 'border-red-500'}`}
                                                sx={{
                                            ...
                                            >
                                                {
                                                    ...
                                                    dataDivNotUse?.length > 0 && (
                                                        <MenuItem value="select-all">
                                                            ...
                                                            <ListItemText primary={<Typography sx={{ fontWeight: 'bold' }} fontSize={14}>Select All</Typography>} />
                                                        </MenuItem>
                                                    )
                                                }

                                                {/* Dynamic options */}
                                                {(mode === 'edit' || mode === 'view' ? divNotUseAndUsed : dataDivNotUse)?.slice() // เพื่อไม่เปลี่ยนต้นฉบับ
                                                    .sort((a: any, b: any) => {
                                        ...
                                        {/* <div className="pb-2">
                                            ...
                                            <input
                                                type="number"
                                                {...register('telephone', { validate: validatePhoneNumber })}
                                        ...
                                        <div className="pb-2">
                                            ...
                                            />
                                            {errors.start_date && <p className={`${textErrorClass}`}>{errors.start_date.message}</p>} */}
                                            <DatePickaForm
                                                {...register('start_date', { required: "Select start date" })}
                                                readOnly={isReadOnly}
                                                placeHolder="Select Start Date"
