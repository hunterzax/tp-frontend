...
const TableEmailGroupForEvent: React.FC<TableProps> = ({ openEditForm, openViewForm, openHistoryForm, openViewModal, tableData, isLoading, columnVisibility, userPermission }) => {
                        ...
                        <thead className="text-xs text-[#ffffff] bg-[#1473A1] sticky top-0 z-1">
                            <tr className="h-9">
                                ...
                                {columnVisibility.person && (
                                    <th scope="col" className={`${table_sort_header_style}`} onClick={() => handleSort("edit_email_group_for_event_match", sortState, setSortState, setSortedData, tableData)}>
                                        {`Person`}
                                            ...
                                            <td className="px-2 py-1">
                                                ...
                                                <div className="relative inline-flex justify-center items-center w-full">
                                                    ...
                                                    {openPopoverId === row?.id && (
                                                        <div ref={popoverRef}
                                                            className="absolute left-[-7rem] top-[-10px] mt-2 w-36 bg-white border border-gray-300 rounded-lg shadow-lg z-50">
                                                            <ul className="py-2">
...
export default TableEmailGroupForEvent;