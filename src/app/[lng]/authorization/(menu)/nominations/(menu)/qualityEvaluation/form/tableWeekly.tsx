...
const TableNomQualityEvaluationWeekly: React.FC<TableProps> = ({ tableData, isLoading, isSearch, tabIndex, columnVisibility, userPermission, gasWeekFilter }) => {
    ...
    let date_next_sunday = gasWeekFilter && isSearch ? formatDateYyyyMmDd(gasWeekFilter) : getCurrentWeekSundayYyyyMmDd()
                        ...
                        <thead className="text-xs text-[#ffffff] bg-[#1473A1] sticky top-0 z-10">
                            <tr className="h-20">
                                ...
                                {columnVisibility.zone && (
                                    <th scope="col" className={`${table_sort_header_style} text-center !min-w-[100px] !max-w-[150px]`} onClick={() => handleSort("zone.name", sortState, setSortState, setSortedData, sortedData)}>
                                        {`Zone`}
                                ...
                                {columnVisibility.area && (
                                    <th scope="col" className={`${table_sort_header_style} text-center !min-w-[100px] !max-w-[150px]`} onClick={() => handleSort("area.name", sortState, setSortState, setSortedData, sortedData)}>
                                        {`Area`}
                                ...
                                {columnVisibility.parameter && (
                                    <th scope="col" className={`${table_sort_header_style} text-center !min-w-[100px] !max-w-[150px]`}
                                        onClick={() => handleSort("parameter", sortState, setSortState, setSortedData, sortedData)}
                                    >
                                        {`Parameter`}
                                ...
                                {dayMapping.map((day, index) => {
                                    const currentDate = toDayjs(date_next_sunday).add(index, "day").format("YYYY-MM-DD");
                                    const formattedDate = toDayjs(currentDate).format("DD/MM/YYYY");
                                    ...
                                    return columnVisibility[columnKey] ? (
                                        <th
                                            ...
                                            onClick={() => handleSort(`${day.toLowerCase() + '.value'}`, sortState, setSortState, setSortedData, sortedData)}
                                        >
                                            <div>{day}</div>
                                    ...
                                    {columnVisibility.sunday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.sunday?.value !== null && row?.sunday?.value !== undefined ? formatNumberThreeDecimal(row?.sunday?.value) : ''
                                            }
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility.monday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.monday?.value !== null && row?.monday?.value !== undefined ? formatNumberThreeDecimal(row?.monday?.value) : ''
                                            }
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility.tuesday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.tuesday?.value !== null && row?.tuesday?.value !== undefined ? formatNumberThreeDecimal(row?.tuesday?.value) : ''
                                            }
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility.wednesday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.wednesday?.value !== null && row?.wednesday?.value !== undefined ? formatNumberThreeDecimal(row?.wednesday?.value) : ''
                                            }
                                        </td>
                                    )}
                                    ...
                                    {columnVisibility.thursday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.thursday?.value !== null && row?.thursday?.value !== undefined ? formatNumberThreeDecimal(row?.thursday?.value) : ''
                                    ...
                                    {columnVisibility.friday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.friday?.value !== null && row?.friday?.value !== undefined ? formatNumberThreeDecimal(row?.friday?.value) : ''
                                    ...
                                    {columnVisibility.saturday && (
                                        <td className={`px-2 py-1 text-right 
                                                ...
                                                ? "text-[#ED1B24]" : "text-[#464255]"}`}>
                                            {
                                                ...
                                                row?.saturday?.value !== null && row?.saturday?.value !== undefined ? formatNumberThreeDecimal(row?.saturday?.value) : ''
...
export default TableNomQualityEvaluationWeekly;