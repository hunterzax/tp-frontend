...
const TableAll: React.FC<any> = ({ tableData, openViewForm, columnVisibility, subTabIndex, isLoading, userPermission, tabEntry }) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            {columnVisibility.capacity_right && (
                                                ...
                                                <td className="px-4 py-1 text-[#464255] max-w-[250px] text-right">{row?.capacityRightMMBTUD !== null && row?.capacityRightMMBTUD !== undefined ? formatNumberFourDecimal(row?.capacityRightMMBTUD) : '0.0000'}</td>
                                            )}

                                            {columnVisibility.nominated_value && (
                                                <td className="px-4 py-1 text-[#464255] max-w-[300px] text-right">{row?.nominatedValueMMBTUD !== null && row?.nominatedValueMMBTUD !== undefined ? formatNumberFourDecimal(row?.nominatedValueMMBTUD) : '0.0000'}</td>
                                            )}

                                            {columnVisibility.overusage && (
                                                <td className="px-4 py-1 text-[#464255] max-w-[300px] text-right">{row?.overusageMMBTUD !== null && row?.overusageMMBTUD !== undefined ? formatNumberFourDecimal(row?.overusageMMBTUD) : '0.0000'}</td>
                                            )}

                                            {columnVisibility.imbalance && (
                                                <td className="px-4 py-1 text-[#464255] max-w-[250px] text-right">{row?.imbalanceMMBTUD !== null && row?.imbalanceMMBTUD !== undefined ? formatNumberFourDecimal(row?.imbalanceMMBTUD) : '0.0000'}</td>
                                            )}
