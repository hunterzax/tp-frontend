...
import { formatNumberFourDecimal, formatNumberThreeDecimal, toDayjs } from "@/utils/generalFormatter";
...
const TableAlloQuery: React.FC<TableProps> = ({ openEditForm, openViewForm, tableData, isLoading, columnVisibility }) => {
                            ...
                            {sortedData && sortedData.map((row: any, key: any) => {
                                return (
                                    ...
                                    >
                                        ...
                                        {columnVisibility?.nominatedval && (
                                            <td className="px-2 py-1 text-[#464255]">
                                                <div className="text-right">{row?.nominationValue ? formatNumberFourDecimal(row?.nominationValue) : null}</div>
                                            </td>
                                        )}

                                        {columnVisibility?.system_allo && (
                                            <td className="px-2 py-1 text-[#464255]">
                                                <div className="text-right">{row?.systemAllocation ? formatNumberFourDecimal(row?.systemAllocation) : null}</div>
                                            </td>
                                        )}
