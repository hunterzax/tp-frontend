...
const ModalSelShipper: React.FC<FormExampleProps> = ({
    mode,
    open,
    shipperGroupData,
    setIdShipper,
                                ...
                                >
...

                                    {
                                        ...
                                        <div className="col-span-2 mt-2">
                                            <label htmlFor="term" className="block mb-2 text-[14px] font-light text-[#58585A]">
                                                {/* <span className="text-red-500">*</span> */}
                                                {`Term`}
                                            </label>
                                            <Select
                                    ...
                                    {
                                        mode == 'upload' && <div className="col-span-2 mt-2">
...
export default ModalSelShipper;