                                    ...
                                    <div className="grid grid-cols-2 gap-2 pt-4">
                                        ...
                                        <div className="col-span-2">
                                            ...
                                            {/* <Select
                                                ...
                                                {...register("process_type_id", {required: "Select Process Type",})}
                                                disabled={isReadOnly}
                                            ...
                                            {errors.process_type_id && (<p className="text-red-500 text-sm">{`Select Process Type`}</p>)} */}
                                        ...
                                        <div >
                                            ...
                                            <SelectFormProps
                                                id={'user_type_id'}
                                                register={register("user_type_id", { required: "Select User Type" })}
                                                disabled={isReadOnly}
                                                valueWatch={watch("user_type_id") || ""}
                                                handleChange={(e) => {
                                                    setValue("user_type_id", e.target.value);
                                                    if (errors?.user_type_id) { clearErrors('user_type_id') }
                                                }}
                                                errors={errors?.user_type_id}
                                                errorsText={'Select User Type'}
                                                options={userTypeMasterData}
                                                optionsKey={'id'}
                                                optionsValue={'id'}
                                                optionsText={'name'}
                                                optionsResult={'name'}
                                        ...
                                        <div >
                                            ...
                                            {/* <Select
                                                ...
                                                IconComponent={(props) => <ExpandMoreIcon {...props} fontSize="medium" />}
                                                {...register("nomination_type_id", {required: "Select Nomination Type",})}
                                                disabled={isReadOnly}
                                            ...
                                            {errors.nomination_type_id && (<p className="text-red-500 text-sm">{`Select Nomination Type`}</p>)} */}

                                            <SelectFormProps
                                                id={'nomination_type_id'}
                                                register={register("nomination_type_id", { required: "Select Nomination Type" })}
                                                disabled={isReadOnly}
                                                valueWatch={watch("nomination_type_id") || ""}
                                                handleChange={(e) => {
                                                    setValue("nomination_type_id", e.target.value);
                                                    if (errors?.nomination_type_id) { clearErrors('nomination_type_id') }
                                                }}
                                                errors={errors?.nomination_type_id}
                                                errorsText={'Select Nomination Type'}
                                                options={nominationTypeMasterData}
                                                optionsKey={'id'}
                                                optionsValue={'id'}
                                                optionsText={'name'}
                                                optionsResult={'name'}
