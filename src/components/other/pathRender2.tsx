...
const RevisedCapacityPathRender2: React.FC<RevisedCapacityPathRenderProps> = ({ sortedRevisedCapacityPath }) => {
    return (
                ...
                sortedRevisedCapacityPath.map((pathItem: any, index: number) => (
                    <div key={index} className="flex items-center gap-2 pt-2 pb-2">
                        <div
                            ...
                            style={{
                                backgroundColor: pathItem?.["color"],
                                width: '30px',
                                height: '30px',
                        ...
                        >
                            <span
                                className={`${index === 0 ? 'text-white' : 'text-black'} text-[13px]`}
                            >
                                {pathItem?.name}
                            </span>
                        </div>
...
export default RevisedCapacityPathRender2;