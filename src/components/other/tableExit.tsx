...
import { adjustDateIfTO, adjustDateIfTOShortTerm, applyDatesToData, extendHeaderDates, extendHeaderDatesForTypeFour, formatDateToDayMonthYear, formatDateToMonthYear, formatMonthYear, formatNumberThreeDecimal, generateDailyRange, generateHeaders, generateMonthlyRange, grandTotalSumCapaContractMgn, mapEntryWithDate, parseDateHeader, sortByMonthYear, sumByZone, summarizeDataByZone, sumValuesByKey, updateDataRowAfterFromTo, updateEntryValWithNewKeys, updateRow, updateRowExit } from '@/utils/generalFormatter';
...
const TableExit: React.FC<any> = ({ columnVisibility, setcolumnVisibility, initialColumnsDynamic, setinitialColumnsDynamic, setGroupRowJsonState, dataTable, mode, isEditing, modeEditing, setDataPostExit, setDataPostEntry, isSaved, setDataHeaderEntry, setDataHeaderExit, setIsDateChange, setIsKeyAfter34Change, originOrSum, isSaveClick, amendNewContractStartDate, isAmendMode, dataContractTermType, isDateChange, setIsReset, isReset, isCancelClick, setIsCancelClick, trickerColumn = false, settrickerColumn, setIsAmendMode, maxDateAmend, selectedBookingTemplate, termTypeId, shadowPeriod }) => {
    ...
    }, [headerEntryDateCapDailyBookingMmbtu, exitValEdited])
    ...
    }, [exitValEdited, dataRowAfterFromTo])
