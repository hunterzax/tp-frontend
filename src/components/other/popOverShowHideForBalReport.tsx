...
const ColumnVisibilityPopoverBalReport: React.FC<ColumnVisibilityPopoverProps> = ({
    open,
    anchorEl,
    setAnchorEl,
    columnVisibility,
        ...
        return columns?.map((column, index) => {
            ...
            return (
                <div key={column.key} className="relative">
                    ...
                    {/* <div className="flex items-center relative" style={{ paddingLeft: `${level * 16}px` }}> */}
...
export default ColumnVisibilityPopoverBalReport;
